# rate-my-housing-server

This repo contains the API - Backend code for rate my housing

### API-Docs
> Api documentation of the publically hosted APIs are available on http://34.218.112.35/api-docs
...
*..Clone..*
> git clone https://git.uwaterloo.ca/team27/rate-my-housing-server.git
